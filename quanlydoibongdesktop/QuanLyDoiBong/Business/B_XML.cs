...
namespace QuanLyDoiBong.Business
{
    public static class B_XML
    {
        ...
        public static List<string> readXMLTINHTP()
        {
            ...
            try
            {
                XElement xelement = XElement.Load(Environment.CurrentDirectory + "../../../Database/XML/TINH_TP.xml");
        ...
        public static List<string> readXMLCOUNTRY()
        {
            ...
            try
            {
                XElement xelement = XElement.Load(Environment.CurrentDirectory + "../../../Database/XML/COUNTRIES.xml");
